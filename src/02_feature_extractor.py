...
def featrure_extractor(config_path,params_path):
    ...
    featrure_extractor_dir=artifacts['feature_extraction_dir']
    extracted_features_name=artifacts['extracted_features_name']

    feature_extraction_path=os.path.join(artifacts_dir,featrure_extractor_dir)
...
if __name__=="__main__":
    ...
    try:
        ...
        featrure_extractor(config_path=parsed_args.config,params_path=parsed_args.params)
